...
TARGET_PREBUILT_KERNEL := device/khadas/t962_p321-kernel/Image.gz
LOCAL_DTB := device/khadas/t962_p321-kernel/t962_p321.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/t962_p321-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/t962_p321-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/t962_p321-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/t962_p321-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/t962_p321-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/t962_p321-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/t962_p321-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
