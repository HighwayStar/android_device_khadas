...
TARGET_PREBUILT_KERNEL := device/khadas/lyell-kernel/Image.gz
LOCAL_DTB := device/khadas/lyell-kernel/lyell.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/lyell-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/lyell-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/lyell-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/lyell-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/lyell-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/lyell-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/lyell-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
