...
TARGET_PREBUILT_KERNEL := device/khadas/t962x_r314-kernel/Image.gz
LOCAL_DTB := device/khadas/t962x_r314-kernel/t962x_r314.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/t962x_r314-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/t962x_r314-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/t962x_r314-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/t962x_r314-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/t962x_r314-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/t962x_r314-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/t962x_r314-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEVICETREE := txlx_t962x_r314
